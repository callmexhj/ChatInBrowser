<template>
    <a-form :model="tongyiModelConfigForm" layout="vertical" @finish="handleFinish" autocomplete="off">
        <a-form-item label="APIKey" name="apiKey"
            ...
            <a-textarea class="textarea" :auto-size="{ minRows: 3, maxRows: 6 }" v-model:value="tongyiModelConfigForm.apiKey"
...
const { tongyiModelConfigForm } = usePopupSystemSettingHome()
const { t } = useI18n()
const AForm = Form
